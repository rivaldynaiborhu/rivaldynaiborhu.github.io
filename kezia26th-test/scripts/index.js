  ...
  if (distance > 0) {
    ...
    function openBox() {
      if (step === 1) {
        ...
        var countdownSeconds = 13;

        // Fungsi untuk menampilkan hitungan mundur dan mengarahkan pengguna setelahnya
        function countdown() {
            // Ambil elemen di mana Anda ingin menampilkan hitungan mundur
            var countdownElement = document.getElementById('countdown');
        
            // Update elemen hitungan mundur dengan nilai saat ini
            countdownElement.innerHTML = "next slide in " + countdownSeconds + "s";
        
            // Kurangi satu detik dari hitungan mundur
            countdownSeconds--;
        
            // Jika hitungan mundur mencapai 0, arahkan pengguna ke halaman tujuan
            if (countdownSeconds < 0) {
               // window.location.href = "happy-birthday/index.html";
                  window.location.href = "Birthday-V3-main/index.html";
            } else {
